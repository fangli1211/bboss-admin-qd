<template>
  <div class="app-container">
    <el-row :gutter="15">
      <el-col :xs="7" :sm="6" :md="4" :lg="5" :xl="4">
        <div class="head-container">
          <el-select v-model="query.type" clearable placeholder="主体" class="filter-item" style="width: 40%">
            <el-option v-for="item in queryTypeOptions" :key="item.key" :label="item.display_name" :value="item.key"/>
          </el-select>
          <el-input v-model="deptName" clearable placeholder="输入部门名称搜索" prefix-icon="el-icon-search" style="width: 55%;" class="filter-item" @input="getDeptDatas"/>
        </div>
